...
Page({
  ...
  button:function(e){
    ...
    var that = this;
    if (operationurl1[index] == "../index/index") {
      wx.switchTab({
        url: '../index/index',
      })
  ...
  button1:function(e){
    ...
    if (operationurl2[index] =="../index/index"){
      wx.switchTab({
        url: '../index/index',
      })
    ...
    request.apiPost2('/order/orderlist', param).then(res => {
      ...
      for (var i = 0; i < res1.length; i++) {
        ...
        if (res1[i].paymentStatus == "refunding") {
          ...
          operationurl2.push("../index/index")
        }
        //待评价，售后服务
        ...
        //已取消
          ...
          operationurl.push("../ order_details / order_details ? orderId = " + res1[i].id)
          operationurl1.push("../index/index")
        }
        //已完成
